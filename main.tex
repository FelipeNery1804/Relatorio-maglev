...
O sistema foi simulado para uma entrada de referência de onda quadrada com 2 mm de amplitude 1 Hz de frequência. O resultado da simulação está presente na figura \ref{fig:simvalidacao}.
