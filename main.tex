...
Posteriormente, foi ajustado o ganho do controlador visualizando a resposta ao degrau do sistema com controlador, figura X, tendo como foco que o tempo de acomodação
...
possui uma chave fim de curso em que corta a alimentação do motor, o sobressinal atrapalha muito o controle. Por fim, a equação do controlador PID obtido é representado
pela equação X.
